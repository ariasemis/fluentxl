...
namespace FluentXL.Specifications.Cells
{
    public interface IExpectCellColumn
    {
        ...
        /// <returns>A new instance of <see cref="IExpectCellContent"/>.</returns>
    ...
    public interface IExpectCellContent
    {
        ...
        /// <returns>A new instance of <see cref="IExpectCellFormat"/>.</returns>
    ...
    public interface IExpectCellFormat : IExpectCellRow
    {
        ...
        /// <returns>A new instance of <see cref="IExpectCellRow"/></returns>
    ...
    public interface IExpectCellRow
    {
        ...
        /// <returns>A new instance of <see cref="IBuilderSpecification{Cell}"/>.</returns>
